...
# Gnuplot Data
_TMP=~/tmp/$0.tmp.$$
_DATA="rimes_fin5_debut6.lev_freq"
_FIC2=${_DATA}.png
...
#echo "set xrange [1:640000]" >> $_TMP
echo "set xrange [1:400]" >> $_TMP
#echo "set xtics (\"0\" 0.1, \"1\" 1, \"10\" 10, \"100\" 100, \"1000\" 1000, \"10000\" 10000, \"100000\" 100000, \"1000000\" 1000000)" >> $_TMP
echo "set xtics (\"0\" 0, \"1\" 1, \"50\" 50, \"100\" 100, \"150\" 150, \"200\" 200, \"250\" 250, \"300\" 300, \"350\" 350, \"400\" 400, \"450\" 450, \"500\" 500, \"550\" 550, \"600\" 600)" >> $_TMP
echo "set yrange [1:100000]" >> $_TMP
