...
echo "set key title \"fréquence d'apparition de 2 prononcations sonores en début de mot\"" >> $_TMP
...
# delete last comma
#sed -i "s/, $//" $_TMP
echo "343.8353*exp(5.5569/(x+2))+-12892.3319/((x+2)**2)+-323.1231 w linespoints linestyle 5 smooth csplines" >> $_TMP
