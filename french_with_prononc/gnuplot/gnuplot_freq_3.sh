...
>$_TMP
f_set_terminal_png 7000 6000
f_set_margins
f_set_styleline 6
echo "set multiplot" >> $_TMP
echo "set key title \"fréquence d'apparition de rimes en début de mots, en séquence, avec des mots ou expressions composés\"" >> $_TMP
